...
#增加resent
python train.py --gpu_ids 0 --data_dir ./data/data --seq_len 11 --batch_size 4 --workers 8 --experiment_name resnet --model_type transfusionodom_cnn --encoder_layer_num 1 --decoder_layer_num 1 --only_encoder --patch_size 16 --imu_height 256 --imu_width 512 --out_dim 128 #--with_src_mask False --cross_first False,其他参数都是false
python test.py --gpu_ids 1 --data_dir ./data/data --seq_len 11 --workers 8 --experiment_name test --model_type transfusionodom --encoder_layer_num 1 --decoder_layer_num 1 --only_encoder --patch_size 16 --imu_height 256 --imu_width 512 --out_dim 128 --model ./results/fusion_image_vit_fix_imu2image_bug/checkpoints/099.pth #--with_src_mask False --cross_first False,其他参数都是false
